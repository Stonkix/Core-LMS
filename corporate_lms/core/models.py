...
class Course(models.Model):
    ...
    allow_self_enroll = models.BooleanField(default=False,
        help_text='Разрешить студентам подключаться по коду доступа')
    access_code = models.CharField(max_length=32, blank=True, null=True,
        help_text='Код для самостоятельного подключения к курсу')
...
class CourseEnrollment(models.Model):
    """Личная запись студента на курс по коду (без группы)"""
